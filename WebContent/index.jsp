...
<body>
	...
	<section class="container">
		...
		<div class="card bg-light mt-3">
			...
			<div class="card-body">
				<h5 class="card-title">
					정말 좋은 강의에요.&nbsp;<small>(2019년 겨울학기)</small>
				</h5>
				<p class="card-text">강의가 많이 널널, 솔직히 배운건 많이 없는거 같지만 학점도 잘 나오고 좋은 것 같습니다.</p>
				<div class="row">
		...
		<div class="card bg-light mt-3">
			...
			<div class="card-body">
				<h5 class="card-title">
					나쁘지는 않은 것 같습니다.&nbsp;<small>(2019년 여름학기)</small>
				</h5>
				<p class="card-text">처음 배웠는데 너무 어렵게 가르치는 것 같네요</p>
				<div class="row">
					<div class="col-9 text-left">
		...
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-left">알고리즘&nbsp;<small>알파고</small></div>
					<div class="col-4 text-right">
						종합<span style="color: red;">A</span>
					</div>
				</div>
			...
			<div class="card-body">
				<h5 class="card-title">
					재미있게 잘 배웠어요.&nbsp;<small>(2019년 2학기)</small>
				</h5>
				<p class="card-text">인공지능 최고에요</p>
				<div class="row">
					<div class="col-9 text-left">
						성적<span style="color: red;">A</span>
						널널<span style="color: red;">C</span>
